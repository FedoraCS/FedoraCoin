...
call configure -debug-and-release -openssl-linked -opensource -confirm-license -platform win32-msvc2012 -nomake examples -nomake tests -static -I \MyProjects\BitcoinDeps\openssl-1.0.1e\inc32 -L \MyProjects\BitcoinDeps\openssl-1.0.1e\out64.dbg -L \MyProjects\BitcoinDeps\openssl-1.0.1e\out64 -l gdi32 -no-opengl -qt-zlib -qt-libpng -qt-libjpeg
nmake
